...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-02-10}
  s.description = %q{Streama is a simple Ruby activity stream gem for use with the Mongoid ODM framework.}
  ...
  s.summary = %q{Streama is a simple Ruby activity stream gem for use with the Mongoid ODM framework.}
  s.test_files = [
    "spec/lib/activity_spec.rb",
    "spec/lib/actor_spec.rb",
    "spec/lib/definition_dsl_spec.rb",
